  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomSection}>
        {/* Subcategory tray — children of the selected category */}
        {selectedCategory && subcategories.length > 0 && (
          <View style={styles.subTray}>
            <ScrollView
              horizontal
            ...
            >
              ...
              {Platform.OS === "ios" && (
                <Pressable style={styles.subAddChip} onPress={onAddSubcategory}>
                  <Text style={styles.subAddChipText}>+ 子类</Text>
                </Pressable>
              )}
            </ScrollView>
          </View>
